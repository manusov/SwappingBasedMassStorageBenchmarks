...
call ConsoleStringWrite
lea edi,[TextBuffer]        ; RDI = Pointer to destination transit buffer
mov eax,[UsedSize]          ; RAX = size in bytes
...
xor eax,eax                  ; EAX = 0
mov [ActionPhase],StepMapW   ; Step name for errors handling, ErrorCode still 0
...
test eax,eax
jz ErrorProgram              ; Go if error create mapping object
xchg ebp,eax                 ; RBP = Mapping Object Handle 
